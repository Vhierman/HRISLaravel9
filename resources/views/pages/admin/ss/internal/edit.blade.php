            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('kaizen.update_ss_internal') }}" method="post"
