        ...
        <main>
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <form action="{{ route('overtime.export_pdf_rekap_overtime_pkwtt') }}" target="_blank" method="post"
                        ...
                        <div class="form-group mt-2">
                            <input type="hidden" class="form-control" name="golongan" readonly value="{{ $golongan }}">
                        </div>
