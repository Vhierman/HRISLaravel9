        ...
        <main>
            ...
            <div class="container-fluid mt-4">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Training Internal</li>
                </ol>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('laporan.tampil_laporan_training_internal') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-grid gap-2 mt-3">
                                        ...
                                        <a href="{{ route('laporan.training_internal') }}" class="btn btn-danger btn-block">
                                            Cancel
                                        </a>
                                    </div>
                                </div>
