            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('kaizen.store_qcc_eksternal') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="nama_group_qcc_eksternal"
                                            ...
                                            value="{{ old('nama_group_qcc_eksternal') }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="circle_leader_qcc_eksternal"
                                            ...
                                            value="{{ old('circle_leader_qcc_eksternal') }}">
                                    </div>
