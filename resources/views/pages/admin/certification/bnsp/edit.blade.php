            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('certification.update', $itemcertification->id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="nomor_sertifikat_bnsp"
                                            ...
                                            value="{{ $itemcertification->nomor_sertifikat_bnsp }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="jenis_sertifikat_bnsp"
                                            ...
                                            value="{{ $itemcertification->jenis_sertifikat_bnsp }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="masa_berlaku_sertifikat_bnsp"
                                            ...
                                            value="{{ $itemcertification->masa_berlaku_sertifikat_bnsp }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_terbit_bnsp"
                                            placeholder="DD-MM-YYYY" value="{{ $itemcertification->tanggal_terbit_bnsp }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="date" class="form-control" name="sampai_tanggal_bnsp"
                                            placeholder="DD-MM-YYYY" value="{{ $itemcertification->sampai_tanggal_bnsp }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="lsp_bnsp"
                                            ...
                                            value="{{ $itemcertification->lsp_bnsp }}">
                                    </div>
