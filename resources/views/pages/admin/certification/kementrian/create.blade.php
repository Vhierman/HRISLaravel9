            ...
            <div class="container-fluid mt-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('certification.store_sertifikasi_kementrian') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="nomor_sertifikat_kementrian"
                                            ...
                                            value="{{ old('nomor_sertifikat_kementrian') }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="jenis_sertifikat_kementrian"
                                            ...
                                            value="{{ old('jenis_sertifikat_kementrian') }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="masa_berlaku_sertifikat_kementrian"
                                            ...
                                            value="{{ old('masa_berlaku_sertifikat_kementrian') }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_terbit_kementrian"
                                            placeholder="DD-MM-YYYY" value="{{ old('tanggal_terbit_kementrian') }}">
                                    </div>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="date" class="form-control" name="sampai_tanggal_kementrian"
                                            placeholder="DD-MM-YYYY" value="{{ old('sampai_tanggal_kementrian') }}">
                                    </div>
